...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            version("grpcVersion", "1.47.0")
            version("protobufVersion", "3.21.2")
            version("reactorGrpcVersion", "1.2.3")
            version("testcontainersSpringBoot", "2.2.2")

            library("aws", "software.amazon.awssdk", "bom").version("2.17.220")
            library("besu", "org.hyperledger.besu", "evm").version("22.4.3")
            library("commonsBeanutils", "commons-beanutils", "commons-beanutils").version("1.9.4")
            library("commonsCodec", "org.apache.commons", "commons-codec").version("1.15")
            ...
            library("headlong", "com.esaulpaugh", "headlong").version("6.5.0")
            library("hederaProtobuf", "com.hedera.hashgraph", "hedera-protobuf-java-api").version("0.27.0")
            library("hederaSdk", "com.hedera.hashgraph", "sdk").version("2.15.0")
            ...
            library("msgpack", "org.msgpack", "jackson-dataformat-msgpack").version("0.9.2")
            ...
            library("vertx", "io.vertx", "vertx-pg-client").version("4.3.1")
